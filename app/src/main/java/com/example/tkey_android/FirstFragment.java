...
public class FirstFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.googleLogin.setOnClickListener(view1 -> {
            ...
            try {
                mAuth.signInWithEmailAndPassword("android@firebase.com", "Android@Web3Auth")
...
//                                    idToken = user.getIdToken(true).toString();
                                    user.getIdToken(true).addOnSuccessListener(new OnSuccessListener<GetTokenResult>() {
                                        ...
                                        public void onSuccess(GetTokenResult result) {
                                            ...
                                            Log.d(TAG, "Sub value = " + sub);

                                            LoginParams loginParams = new LoginParams("web3auth-firebase-examples", sub, idToken);
                                            SingleFactorAuthArgs singleFactorAuthArgs = new SingleFactorAuthArgs(TorusNetwork.TESTNET);
                                            SingleFactorAuth singleFactorAuth = new SingleFactorAuth(singleFactorAuthArgs);
                                            try {
